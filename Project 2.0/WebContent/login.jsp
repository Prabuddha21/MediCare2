					...
					<form method="POST" action="Login">
						<div class="row form-group">
							<div class="col-md-6">
								...
								<input type="text" id="uname" name="uname" class="form-control mb" placeholder="">
							</div>
							<div class="col-md-6">
							...
							<input type="hidden" value="<%=request.getParameter("docID")%>" name="docID">
	  						<input type="hidden" value="<%=request.getParameter("hosp")%>" name="hosp">
						...
						<div class="form-group text-center">
							...
							<br>
							<a href="forgot.jsp" class="btn btn-primary">Forgot your password ?</a>
						</div>
