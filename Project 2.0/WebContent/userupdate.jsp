		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-10 col-md-offset-1 animate-box">
					<h3><hr><big>Update Profile</big></h3>
					<%
					...
					<form method="POST" action="UpdatePatient">
						...
						<div class="row form-group">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" name="age" value="<%= p.getAge() %>" required>
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-6">
						...
						<div class="row form-group">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" name="c1" value="<%= p.getCont1() %>" required>
								<input type="hidden" class="form-control" name="c1o" value="<%= p.getCont1() %>" required>
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" name="c2" value="<%= p.getCont2() %>" required>
								<input type="hidden" class="form-control" name="c2o" value="<%= p.getCont2() %>" required>
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" name="add" value="<%= p.getAdd() %>" required>
							</div>
						</div>
