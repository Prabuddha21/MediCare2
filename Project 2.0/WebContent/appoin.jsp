					...
					<form action="#" class="appointment-wrap animate-box">
						<div class="row form-group">
							<div class="col-md-6">
								...
								<input type="text" id="fname" class="form-control" placeholder="Doctors name here">
							</div>
							...
							<div class="col-md-12">
								...
								<select class="selectpicker form-control">
									...
									<option value="1">Allergy & Immunology</option>
													<option value="1">Adult Reconstructive Orthopaedics</option>
													<option value="1">Cardiothoracic</option>
													...
													<option value="1">Physical Medicine & Rehabilitation</option>
													<option value="1">Plastic Surgery</option>
													<option value="1">Rheumatology </option><option value="1">Surgery</option>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<select class="selectpicker form-control">
									<option value="1">Any</option>
									<option value="1">Asiri Hospital, Colombo</option>
													<option value="1">Durdans Hospital, Colombo</option>
													<option value="1">Lanka Hospitals, Colombo</option>
													<option value="1">Nawaloka Hospital, Colombo</option>
													<option value="1">Cooperative Hospital, Kurunegala</option>
													<option value="1">Seth Sevana Hospital, Kurunegala</option>
													<option value="1">Miracle Health hospital Kurunegala </option>
													<option value="1">Kandy Nursing Home, Kandy</option>
													<option value="1">Lake Side Hospital, Kandy</option>
													<option value="1">Hemas Southern Hospital, Galle</option>
													<option value="1">Royal Hospital, Anuradhapura</option>
													<option value="1">Central Hospital, Badulla</option>
													<option value="1">Hemas Hospital, Wattala</option><option value="1">Browns Hospital, Ragama</option>
													<option value="1">Radiant Eye Hospital, Ja-Ela</option>
								</select>
								</div>
								</div>
