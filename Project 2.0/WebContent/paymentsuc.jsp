		...
		<div class="container">
			<div class="row">
				...
				<center>
					...
					<br>
					<h3><strong>Your payment Successfully recived !</strong></h4>
					
					<h4>Amount</h4> 
					
					<p><b>Doctor's and hospital payment : Rs.<%= (double)request.getAttribute("amount") - 250 %><b></p>
					<br>
					<p><b>**Service chargers : Rs. 250.00<b></p>
										
					<h4>Check your email for more informations</h2>
