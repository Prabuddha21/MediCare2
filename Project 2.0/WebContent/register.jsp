		   			...
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 col-sm-12 col-xs-12 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1>Register With <strong>MediCare</strong></h1>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-10 col-md-offset-1 animate-box">
					<h3>Registration</h3>
					<p>Fill the following form with your correct information</p>
					...
					<form method="post" action="Registration" >
						...
						<div class="row form-group">
							...
							<div class="row form-group">
							<div class="col-md-8">
								<label for="umname">User Name</label>
								<input type="text" name="uname" id="uname" class="form-control" placeholder="Your User Name for login" required>
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-8">
								...
								<input type="password" name="pass" id="pass" class="form-control" placeholder="Your password here" required>
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-8">
								...
								<input type="password" name="pass" id="pass" class="form-control" placeholder="Re-enter your password" oninput="check(this)" required>
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-8">
								...
								<input type="text" id="name" name="name" class="form-control" placeholder="Your Name here" required>
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-8">
								...
								<input type="text" name="NIC" id="NIC" class="form-control" placeholder="Your NIC number here" required>
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-8">
								...
								<input type="text"  name="age" id="age" class="form-control" placeholder="Your age here" required>
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-8">
								...
								<input type="text"  id="phone1" name="phone1" class="form-control" placeholder="Your contact number here" required>
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-8">
								<label for="phone">Contact Number</label>
								<input type="text"  id="phone2" name="phone2" class="form-control" placeholder="Your contact number here" required>
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-8">
								<label for="address">Address</label>
								<input type="text" name="address" id="address" class="form-control" placeholder="Your address here" required>
							</div>
						</div>
