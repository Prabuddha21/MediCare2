...
<body>
	...
	<aside id="colorlib-hero" class="hero">
		<div class="flexslider">
			<ul class="slides">
		   	<li style="background-image: url(images/img8.jpeg);">
	...
	<div id="colorlib-contact">
		<div class="container">
			...
			<h3>Enter your payment details</h3>
					<form method="POST" action="DoPayment" class="appointment-wrap animate-box">
					<center>
					<img src="images/cards.png" height="35px" width="240px">
					</center>
						<div class="row form-group">
							<div class="col-md-6">
								<label for="name">Name on Card</label>
								<input type="text" id="name" name="cardname" class="form-control" placeholder="Name on Card" required>
							</div>
						...
						<div class="row form-group">
							<div class="col-md-6">
								...
								<input type="number" id="num" name="cardnum" class="form-control" placeholder="Number on the Card" required>
							</div>
						...
						<div class="row form-group">
							<div class="col-md-6">
								...
								<input type="ExpiryDate" id="exdate" name="expdate" class="form-control" placeholder="MM/YY" required>
							</div>
						...
						<div class="row form-group">
							<div class="col-md-6">
								...
								<input type="csv" id="csv" name="csv" class="form-control" placeholder="CSV Number" required>
							</div>
