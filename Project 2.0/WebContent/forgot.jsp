		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-10 col-md-offset-1 animate-box">
					...
					<h3>An email containing a code will be sent. Check you mail and acquire the code</h3>
					<form method="POST" action="GetCode">
						<div class="row form-group">
							<div class="col-md-6">
								<label for="fname">Email</label>
								<input type="text" id="email" name="email" class="form-control mb" placeholder="">
							</div>
						</div>
						<div class="form-group text-center">
							<input type="submit" value="Get Code" class="btn btn-primary">
						</div>
