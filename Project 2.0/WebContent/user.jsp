		...
		<div class="container">
			<div class="row">
				<div style="background-color:lightblue">
					<center>
						<label for="email"><u><big>Notice Board</big></u></lable>
					</center>
					<%
						PatientService ps = new PatientService();
						String[] var = new String[10];
						
						var = ps.getEventDetails();
				...
				<br>
				<div class="col-md-10 col-md-offset-1 animate-box" style="background-color:#efeae9;">
					<h3><hr><big>User Profile</big></h3>
					<%
						Patient p = new Patient();
						p = ps.getPatient((int)session.getAttribute("userID"));
						
					%>
					<form>
						<div class="row form-group">
							<div class="col-md-6">
								<center><label for="fname">User Name :</label></center>
							</div>
							<div class="col-md-6">
								<input type="text" disabled = "disabled" class="form-control" value="<%= p.getUname() %>" >
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-6">
								<center><label for="fname">Name :</label></center>
							</div>
							<div class="col-md-6">
								<input type="text" disabled = "disabled" class="form-control" value="<%= p.getName() %>" >
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-6">
								<center><label for="fname">Age :</label></center>
							</div>
							<div class="col-md-6">
								<input type="text" disabled = "disabled" class="form-control" value="<%= p.getAge() %>" >
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-6">
								<center><label for="fname">NIC :</label></center>
							</div>
							<div class="col-md-6">
								<input type="text" disabled = "disabled" class="form-control" value="<%= p.getNIC() %>" >
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-6">
								<center><label for="fname">Email :</label></center>
							</div>
							<div class="col-md-6">
								<input type="text" disabled = "disabled" class="form-control" value="<%= p.getEmail() %>" >
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-6">
								<center><label for="fname">Contact 1 :</label></center>
							</div>
							<div class="col-md-6">
								<input type="text" disabled = "disabled" class="form-control" value="<%= p.getCont1() %>" >
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-6">
								<center><label for="fname">Contact 2 :</label></center>
							</div>
							<div class="col-md-6">
								<input type="text" disabled = "disabled" class="form-control" value="<%= p.getCont2() %>" >
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-6">
								<center><label for="fname">Address :</label></center>
							</div>
							<div class="col-md-6">
								<input type="text" disabled = "disabled" class="form-control" value="<%= p.getAdd() %>" >
							</div>
						</div>
						
						<div class="form-group text-center">
							<a href="userupdate.jsp" class="btn btn-primary">
								Update Details
							</a>
						</div>
