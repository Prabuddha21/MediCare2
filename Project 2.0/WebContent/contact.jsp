				...
				<div class="row">
					<div class="col-xs-12">
						<div class="top">
							<div class="row">
								<div class="col-md-6">
									<div id="colorlib-logo"><a href="index.jsp"><i class="flaticon-stethoscope"></i>Medi<span>care</span></a></div>
								</div>
								<div class="col-md-3">
									<div class="num">
							...
							<div class="menu-1">
								<ul>
									...
									<li class="has-dropdown">
										...
										<ul class="dropdown">
											<li><a href="doctors-single.jsp">Single Doctor</a></li>
										</ul>
									</li>
									...
									<li class="has-dropdown">
										...
										<ul class="dropdown">
											<li><a href="blog-single.jsp">Single Blog</a></li>
										</ul>
									</li>
			...
			<div class="row row-pb-md">
				...
				<div class="col-md-3 colorlib-widget">
					...
					<form class="contact-form">
						...
						<div class="form-group">
							<input type="submit" id="btn-submit" class="btn btn-primary btn-send-message" value="Send Message">
						</div>
					</form>
				</div>
			</div>
