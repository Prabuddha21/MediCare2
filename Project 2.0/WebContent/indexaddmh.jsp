...
<html>
	...
	<center>
	<form method="POST" action="Addmedhistory">
		<table>
			
			<tr>
				<td>Patient user name:</td>
				<td><input type="text" name="pUName">
			</td>
			</tr>
			<tr>
				<td>MID:</td>
				<td><input type="text" name="doctor" value="<%= MID%>"/></td>
			<tr>
				<td>Description:</td>
				<td><textarea rows="7" cols="35" name="desc"></textarea></td>
			</tr>
